...
from wan_lib.interface.ipsec import IpsecService
from wan_lib.manager import NetworkManager

class PrivateInterface(Server):
    ...
    def __init__(self,
        ...
        self.register(IpsecService(event_system, logger, network_manager))

    def get_address(self) -> str:
        return self._wan_settings.get_private().get_address()

    def get_credentials(self) -> Credentials:
        return self._wan_settings.get_private().get_credentials()
